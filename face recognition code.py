...
image = CurrentFolder+'\\khamis.jpg'
image2 = CurrentFolder+'\\youssef.jpg'
...
khamis_image = face_recognition.load_image_file(image)
khamis_face_encoding = face_recognition.face_encodings(khamis_image)[0]

# Load a second sample picture and learn how to recognize it.
youssef_image = face_recognition.load_image_file(image2)
youssef_face_encoding = face_recognition.face_encodings(youssef_image)[0]

# Create arrays of known face encodings and their names
known_face_encodings = [
    khamis_face_encoding,
        ...
        while(1):
            ...
            if process_this_frame:
                ...
                for face_encoding in face_encodings:
                    ...
                    if(name == "Unknown"):
                        ...
                        if(serial_data == b'p'):
                            ...
                            while i < 10:
                                ...
                                Reciever_Email = "yourReciver@gmail.com"
                                Password = "************" #type sender password here
                    ...
                    elif((name == "khamis_mdeghi") or (name == "youssef_mejri")):
                        s.write(b'1')
